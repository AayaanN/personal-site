 ...
 const Work_Block = ({company, title, date, description, technologies, link}) => {
    ...
    return(
        <a href={link} target="_blank" rel="noopener noreferrer">
            <div className={`mt-12 w-full border-[2px] border-white/5 p-4 rounded-xl hover:bg-white/5 hover:shadow-xl text-white`} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseExit}>
